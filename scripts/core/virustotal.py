...
pub_vt = ['9bac36e9b2ec6231f6bf1fae6965636e05bccf437ce97d38573a964065c04027', 'ea2a18694c1c76283c80f8567e86b1d3cafa39c5882cb8d5480d1d3c4a1fbfe6']
...
def scan_domain(domain):
    ...
    try:
        ...
        response = response.json()
        # print("BEJ", response['response_code'])
        if response['response_code'] == 1:
...
def domain_batch_scan(domains):
    #print("receiving domains", domains)
    ...
    if core.virustotal_api != "":
        ...
        for index,domain in enumerate(domains):
            ...
            if gotta_wait and real_index%4 == 0:
                print('Sleeping for 1 minute... virustotal api limit reached!')
                ...
                time.sleep(60)
            #print('Getting virustotal report for: ' + domain)
            try:
                url = 'https://www.virustotal.com/vtapi/v2/domain/report'
        ...
        for _domain in domains:
            #print('Skipping virustotal domain scan for {0}. Reason: No virustotal api added!'.format(_domain))
